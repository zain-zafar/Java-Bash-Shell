...
public class EchoOverwrite extends Echo {
  ...
  /**
   * This method will clear the contents in a given file and call
   * its super class to write onto the file.
  ...
  public void printToFile(String toPrint, String fileName) {
    // try and catch the PrintWriter
    try {
      // overwrite what is on the file
