 ...
 */
public class PopDirectory extends Commands implements CommandsInterface {
  
  /**
   * Pops the top directory on the directory stack and changes it
  ...
  /**
   * Calls the popd method to pop a directory off of the directory stack
   * and changes it to the current directory.
  ...
  public void execute(JShell shell, Object instanceOfClass,
      String[] cleanedInput) {
    ((PopDirectory) instanceOfClass).popd();
